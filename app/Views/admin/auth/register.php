                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <!-- Form Submission to Register Route -->
                                <form method="post" action="<?= base_url('admin/register') ?>">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirm password" name="password_confirm" required />
                            ...
                            <div class="card-footer text-center py-3">
                                <div class="small"><a href="<?= base_url('admin/login') ?>">Have an account? Go to login</a></div>
                            </div>
                        </div>
                    </div>
                </div>
